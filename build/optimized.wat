(module
 ...
 (data (i32.const 400) "\05\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\93\00\00\00\02")
 ...
 (export "addabcd" (func $assembly/index/addabcd))
 ...
 (func $~lib/array/Array<u32>#__set (; 21 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $1
  local.get $0
  i32.load offset=12
 ...
 (func $~lib/array/Array<u32>#__get (; 22 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $1
  local.get $0
  i32.load offset=12
  i32.ge_u
 ...
 (func $assembly/hash2x/hash2x (; 23 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $1
  i32.const 255
  i32.and
 ...
 (func $assembly/index/State#hash_ee_state (; 24 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  i32.load
 ...
 (func $assembly/index/State#constructor (; 25 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  loop $for-loop|0
   local.get $0
 ...
 (func $assembly/index/State#get:ee_state (; 26 ;) (param $0 i32) (result i32)
  local.get $0
  i32.load
  call $~lib/rt/pure/__retain
 )
 (func $assembly/index/State#set:ee_state (; 27 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $1
  local.get $0
  i32.load
 ...
 (func $assembly/index/State#get:state_root (; 28 ;) (param $0 i32) (result i32)
  local.get $0
  i32.load offset=4
 )
 (func $assembly/index/State#set:state_root (; 29 ;) (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store offset=4
 )
 (func $assembly/index/addabcd (; 30 ;) (result i32)
  i32.const 0
 )
 (func $~start (; 31 ;)
  i32.const 0
